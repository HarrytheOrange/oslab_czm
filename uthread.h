...
//#define MAX_THREAD_NAME_LEN 128  // Added this line

struct uthread *threads[MAX_THREADS];  // Array of all threads
int current_thread_index;              // Index of the currently running thread
...
struct uthread {
  ...
  const char *name;
  //char name[MAX_THREAD_NAME_LEN];  // Modified this line
